...
if __name__ == "__main__":
    ...
    timer = Timer()
    print("Update loop started. ", num_updates, " updates in total.")
    for update in range(1, num_updates + 1):
        ...
        value_data = []
        policy_data = []
        print("Step loop started:", args.num_steps, "steps in total.")
        for step in range(args.num_steps):  
            ...
            # 観測情報をtorch.geometric.data.Data, Batchに変換
            new_value_data = []
            new_policy_data = []
        ...
        clipfracs = []
        print("Epoch loop started:", args.update_epochs, "epochs in total.")
